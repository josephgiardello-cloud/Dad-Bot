...
from dadbot.managers.long_term import LongTermSignalsManager as _LTS
...
def accumulate_memory_graph_node(node_weights, node_types, label, node_type, weight: int = 1):
    ...
    return _LTS.accumulate_memory_graph_node(node_weights, node_types, label, node_type, weight=weight)
